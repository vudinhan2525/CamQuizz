...
namespace CamQuizzBE.Infras.Data.Migrations
{
    ...
    [Migration("20250604123647_SharedUserAndGroupToQuizzes2")]
    partial class SharedUserAndGroupToQuizzes2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CamQuizzBE.Domain.Entities.QuizReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CamQuizzBE.Domain.Entities.QuizReport", b =>
                {
                    ...
                    b.HasOne("CamQuizzBE.Domain.Entities.AppUser", "Reporter")
                        .WithMany()
                        .HasForeignKey("ReporterId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CamQuizzBE.Domain.Entities.AppUser", "ResolvedBy")
                        .WithMany()
